...
import com.mhd.views.PurchaseReportView;
import com.mhd.views.PurchaseView;
import com.mhd.views.SalesReportView;
import com.mhd.views.SalesView;
import com.mhd.views.SignUpView;
import com.mhd.views.UserReportView;
...
public class MenuFormAdmin {
    ...
    public static JMenuBar commonMenuForAdmin(JFrame f) {
        ...
        JMenuItem user = new JMenuItem("AddUser");
